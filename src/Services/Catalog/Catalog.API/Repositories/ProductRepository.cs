...
namespace Catalog.API.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            FilterDefinition<Product> filter = Builders<Product>.Filter.Eq(a => a.Category, category);
        ...
        {
            var updateResult = await _context.Products.ReplaceOneAsync(filter: a => a.Id == product.Id, replacement: product);
